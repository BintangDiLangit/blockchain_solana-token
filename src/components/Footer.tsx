...
export const Footer: FC = () => {
  ...
  if (state.succeeded) {
    return (
      ...
      >
        Thanks for sending your message! We'll get back to you soon.
      </h1>
    );
  }
  const menuOne = [
  ...
  return (
    <footer className="bg-default-950/40 backdrop-blur-3xl">
            ...
            <div className="bg-primary/20 rounded-xl">
              <div className="p-10">
                ...
                <p className="text-default-200 mb-6 text-base font-medium">
                  SignUp and received our latest news and updates
                </p>
                <form onSubmit={handleSubmit} className="mb-6 space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      w-full rounded-lg border-white/10 py-4 text-white backdrop-blur-3xl focus:border-white/10
                      focus:ring-0"
                    />
                    <button
                      type="submit"
                  ...
                  <ul className="flex flex-wrap items-center gap-1">
                    {[
                      ...
                      <li key={index}>
                        ...
                        justify-center rounded-lg border border-white/10 transition-all
                        duration-500"
                        >
                          <i
      ...
      <div className="border-t border-white/10 py-6">
        <div
          className="md:text-start conatiner flex h-full flex-wrap
