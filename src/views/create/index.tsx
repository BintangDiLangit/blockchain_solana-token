              ...
              <div className="grid gap-10 lg:grid-cols-2">
                <div className="ps-4 hidden py-4 pt-10 lg:block">
                  ...
                  <textarea
                    ...
                    className="border-default-200 relative mt-48 block w-full
                    rounded border-white/10 bg-transparent py-1.5 px-3
                    ...
                    <div className="text-start">
                      ...
                      <div className="mb-6 text-center">
                        <button
                          ...
                          mt-5 inline-flex w-full items-center justify-center rounded-lg px-6 py-2
                        ...
                        <li>
                          <a
                            ...
                            className="group inline-flex h-10 w-10 items-center 
                              justify-center rounded-lg bg-white/20
                ...
                <div className="lg-ps-=0 flex h-full flex-col p-10">
                  ...
                  <div className="my-auto pb-6 text-center">
                    ...
                    <p className="text-default-300 mx-auto mb-5 max-w-sm">
                      Your Solana token has been created successfully, Check now
                      solana explorer
                    </p>
