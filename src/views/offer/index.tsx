          ...
          <div className="mb-10 flex items-end justify-between">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="text-default-200 text-sm font-medium">
                ...
                hic iure aliquam placeat distinctio sit aspernatur atque
                perferendis repellendus rem!
              </p>
            </div>
          </div>
              ...
              >
                <div className="p-10">
                  ...
                  <p className="text-default-100 mb-4 text-sm font-medium">
                    ...
                    Commodi excepturi exercitationem quasi quidem? Dicta commodi
                    quia sapiente molestias iusto.
                  </p>
                  <a
                    href="#"
                  ...
                  >
                    <span
                      className="bg-primary/80 absolute -bottom-0 h-px w-7/12 rounded transition-all duration-500
                    group-hover:w-full"
                    >
